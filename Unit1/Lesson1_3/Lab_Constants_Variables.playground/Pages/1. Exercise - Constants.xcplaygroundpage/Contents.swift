...
print("Because friends is a constant variable, it cannot accept a new value once assigned.")
print("That is why when given a new, altered value, the program will not execute properly.")
/*:
