...
var steps = "2,957"
let stepGoal = "10,000"
print("I'm not sure what I'm meant to do to format the number in a more readable way other than to add commas, which would require turning it into a string.")
/*:
