...
print("A variable, unlike a constant, is created with the capability to be altered in later lines of code.")
print("Because of this, the schooling variable can be changed without error.")
/*:
