...
print("Due to the use of doubles, the result is more precise down to the decimal.")
/*:
...
print(even%2)
print(odd%2)
print("The remainder operator would allow you to see whether a number was odd by checking a number in a binary way. If there is a remainder when divided by two, a number is always odd.")
/*:
