...
print(averageHRD)
print("Yes, the answer is different technically. It has a decimal place, because it was created using doubles. However, because it was calculated using whole numbers, it is the same result.")
