...
case 141...160:
    print("You are in the Moderate zone. Activity in this zone increases maximum performance capacity for shorter sessions.")
case 161-180:
...
default:
    print("Warning. Even experienced athletes have limits. For your safety, it is advised that you slow down.")
}
/*:
