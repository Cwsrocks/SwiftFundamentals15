...
var caleb = User(name: "Caleb Sublett", age: 19, height: 67, weight: 210, activityLevel: 4)
print("The user \(caleb.name) is \(caleb.age) years old, \(caleb.height) inches tall, weighs \(caleb.weight) pounds, and has an activity level of \(caleb.activityLevel).")
/*:
