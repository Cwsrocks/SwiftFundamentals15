...
var newWorkout = RunningWorkout(distance: 500, time: 1, elevation: 90)
...
var newStepCount = Steps(steps: 9999, goal: 10000)
newStepCount.takeStep()
print(newStepCount.steps)
/*:
