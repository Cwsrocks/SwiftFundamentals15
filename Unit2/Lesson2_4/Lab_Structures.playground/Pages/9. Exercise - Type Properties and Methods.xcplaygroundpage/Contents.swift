 ...
 */
struct User {
    static var currentUser = User(userName: "xX_CurrentUser_Xx", email: "Obnoxiousexample@hotmail.com", age: 12)
    var userName: String
    var email: String
    var age: Int
 ...
 */
var newUser = User(userName: "NewerUser6000", email: "Betterexample@yahoo.com", age: 16)
