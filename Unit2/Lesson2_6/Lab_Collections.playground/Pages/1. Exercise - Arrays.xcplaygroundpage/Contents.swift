...
registrationList += ["Myles", "Alayna", "Maddy", "Jason"]
print(registrationList)
...
// I'm assuming that the second element means inserted at two, but I know that if I want it to be the second element read then it should be inserted at one.
