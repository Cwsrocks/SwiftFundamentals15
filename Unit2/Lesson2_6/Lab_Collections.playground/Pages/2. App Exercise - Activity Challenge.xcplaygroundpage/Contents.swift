 ...
 */
let walkingChallenges: [String] = ["Walk 5 miles in a day", "Walk every day this week"]
let runningChallenges: [String] = ["Run 1 mile in a day", "Run 3 times this week"]
