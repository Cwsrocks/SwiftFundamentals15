...
print("Primarily, this doesn't work because falcon is not present on this page. However, it also does not work because falcon is only a spaceship, not a member of the fighter class.")
